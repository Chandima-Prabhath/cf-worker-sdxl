...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cf-worker-sdxl)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cf-worker-sdxl
```

A live public deployment of this template is available at [https://cf-worker-sdxl.templates.workers.dev](https://cf-worker-sdxl.templates.workers.dev)
